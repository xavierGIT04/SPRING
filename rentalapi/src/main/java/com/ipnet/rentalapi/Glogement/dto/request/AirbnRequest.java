...
public class AirbnRequest {
	...
	public AirbnRequest(String libelle, BienEnum typebien, String ville, String quartier,
			String description, TypeUnite typeUnite, StatutUnite statut, BigDecimal prix_nuite) {
		super();
